  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      ...
      <Card className="border-0 shadow-2xl overflow-hidden">
        <div className="h-3 bg-gradient-to-r from-[#E76F51] to-[#F4A261]" />
        <CardContent className="p-8 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            This challenge is available for users at Level 3 and above.
          </p>
          <div className="flex items-center justify-center gap-2 text-[#E9C46A] mb-6">
            <Timer className="w-5 h-5" />
            <span className="font-semibold">+30 XP Reward</span>
          </div>
