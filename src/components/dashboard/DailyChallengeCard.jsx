...
export default function DailyChallengeCard({ completed = false }) {
  ...
  return (
    <Card className="border-2 border-[#E9C46A] bg-gradient-to-br from-white to-[#E9C46A]/10 dark:from-slate-800 dark:to-[#E9C46A]/10 shadow-lg shadow-[#E9C46A]/20">
      <CardContent className="p-6">
        <div className="flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#E9C46A] to-[#F4A261] flex items-center justify-center shadow-lg">
            <Trophy className="w-7 h-7 text-white" />
          </div>
          <div className="flex-1">
            <div className="flex items-center gap-2">
              <h3 className="font-semibold text-lg">Daily Challenge</h3>
              <span className="px-2 py-0.5 rounded-full bg-[#E9C46A]/20 text-[#E9C46A] text-xs font-bold flex items-center gap-1">
                <Zap className="w-3 h-3" />
                +50 XP
              </span>
            </div>
            <p className="text-sm text-muted-foreground mb-1">Test your skills in a timed challenge</p>
          ...
          <Link to={createPageUrl('DailyChallenge')}>
            <Button className="bg-gradient-to-r from-[#E9C46A] to-[#F4A261] hover:from-[#F4A261] hover:to-[#E9C46A] text-white shadow-lg">
              Start Challenge
            </Button>
          </Link>
        </div>
